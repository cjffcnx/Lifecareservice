...
// Make variable
    ...
    // Make SQL Query
    $sql="INSERT INTO `trip`.`message` (`message`, `dt`) VALUES ( '$message', current_timestamp());";
    // INSERT INTO `message` (`sno`, `message`, `dt`) VALUES ('1', 'This is a message', '2023-11-10 10:01:43.000000');
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex" role="search">
                  <a href="login/register.php"><button type="button" class="btn btn-outline-danger">Login/Signup</button></a>
                  <a href="log.php"><button type="button" class="btn btn-outline-danger">Admin Login</button></a>
